...
<div class="container-fluid"> 
    <div class="pix1">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <img src="pictures/green2.jpg" class="img img-fluid ankara"id="pix2" alt="">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <a href=""><img src="pictures/green17.jpg" id="img2" class="img img-fluid ankara" alt=""></a>
                        ...
                        <div class="col-sm-3">
                            <img src="pictures/agbada.jpg" id="img3" class="img img-fluid ankara" alt="">
                            <section class="text-center" style="height:30px;width:100px;background-color:brown;color:ghostwhite;font-family: 'Times New Roman', Times, serif;font-size:20px;margin-top:-50px;margin-left:30px;">
                                Shop Now
                            </section>
                        </div>
                        <div class="col-sm-3">
                            <img src="pictures/green2.jpg"  id="img4" class="img img-fluid ankara" alt="">
                            <section class="text-center" style="height:30px;width:100px;background-color:brown;color:ghostwhite;font-family: 'Times New Roman', Times, serif;font-size:20px;margin-top:-50px;margin-left:30px;">
                                Shop Now
                            </section>
                        </div>
                        <div class="col-sm-3">
                            <img src="pictures/green20.jpg"  id="img5" class="img img-fluid ankara" alt="">
                            <section class="text-center" style="height:30px;width:100px;background-color:brown;color:ghostwhite;font-family: 'Times New Roman', Times, serif;font-size:20px;margin-top:-50px;margin-left:30px;">
                                Shop Now
                            </section>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <a href=""><img src="pictures/agbada6.jpg" id="img6" class="img img-fluid ankara" alt=""></a>
                            <section class="text-center" style="height:30px;width:100px;background-color:brown;color:ghostwhite;font-family: 'Times New Roman', Times, serif;font-size:20px;margin-top:-50px;margin-left:30px;">
                                Shop Now
                            </section>
                        </div>
                        <div class="col-sm-3">
                            <img src="pictures/agbada3.jpg" id="img7" class="img img-fluid ankara" alt="">
                            <section class="text-center" style="height:30px;width:100px;background-color:brown;color:ghostwhite;font-family: 'Times New Roman', Times, serif;font-size:20px;margin-top:-50px;margin-left:30px;">
                                Shop Now
                            </section>
                        </div>
                        <div class="col-sm-3">
                            <img src="pictures/agbada4.jpg"  id="img8" class="img img-fluid ankara" alt="">
                            <section class="text-center" style="height:30px;width:100px;background-color:brown;color:ghostwhite;font-family: 'Times New Roman', Times, serif;font-size:20px;margin-top:-50px;margin-left:30px;">
                                Shop Now
                            </section>
                        </div>
                        <div class="col-sm-3">
                            <img src="pictures/agbada9.png"  id="img9" class="img img-fluid ankara" alt="">
                            <section class="text-center" style="height:30px;width:100px;background-color:brown;color:ghostwhite;font-family: 'Times New Roman', Times, serif;font-size:20px;margin-top:-50px;margin-left:30px;">
                                Shop Now
                            </section>
                        </div>
