    <!-- text heading -->
    <h5 class="text-center" id="head_title" style="color:ghostwhite;">GET IN TOUCH WITH OUR LATEST ARRIVALS</h5>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <br><br>
                    <!-- fonts -->
                    <h5 style="font-size:15px;font-family: 'Times New Roman', Times, serif;color:gold;">Stay connected</h5>
                    <a href="#"> <i class="fa fa-facebook-official fa" style="margin-left: auto;color: grey; font-size: 35px; margin-top: auto;"></i></a>
                    <a href="#"> <i class="fa fa-twitter-square fa" style="margin-left: auto;color: grey; font-size: 35px; margin-top: auto;"></i></a>
                    <a href="#"> <i class="fa fa-instagram fa" style="margin-left: auto;color: grey; font-size: 35px; margin-top: auto;"></i></a>
                    <a href="#"> <i class="fa fa-youtube-play fa" style="margin-left: auto;color: grey; font-size: 35px; margin-top: auto;"></i></a>
                    <a href="#"> <i class="fa fa-whatsapp fa" style="background-color:grey; margin-left: auto; color: white; font-size: 35px; margin-top: auto;"></i></a>
                    <a href="#"> <i class="fa fa-linkedin-square fa" style="margin-left: auto;color: grey; font-size: 35px; margin-top: auto;"></i></a>
                </div>
                <div class="col-md-3">
                    <br>
