...
<div class="container-fluid"> 
    <div class="pix1">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <img src="pictures/green3.jpg" class="img img-fluid ankara"id="pix2" alt="">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <a href=""><img src="pictures/green36.jpg" id="img2" class="img img-fluid ankara" alt=""></a>
                ...
                <div class="col-sm-3">
                    <img src="pictures/agbada42.png" id="img3" class="img img-fluid ankara" alt="">
                    <section class="text-center" style="height:30px;width:100px;background-color:brown;color:ghostwhite;font-family: 'Times New Roman', Times, serif;font-size:20px;margin-top:-50px;margin-left:30px;">
                        Shop Now
                    </section>
                </div>
                <div class="col-sm-3">
                    <img src="pictures/green3.jpg"  id="img4" class="img img-fluid ankara" alt="">
                    <section class="text-center" style="height:30px;width:100px;background-color:brown;color:ghostwhite;font-family: 'Times New Roman', Times, serif;font-size:20px;margin-top:-50px;margin-left:30px;">
                        Shop Now
                    </section>
                </div>
                <div class="col-sm-3">
                    <img src="pictures/agbada41.png"  id="img5" class="img img-fluid ankara" alt="">
                    <section class="text-center" style="height:30px;width:100px;background-color:brown;color:ghostwhite;font-family: 'Times New Roman', Times, serif;font-size:20px;margin-top:-50px;margin-left:30px;">
                        Shop Now
                    </section>
                </div>
            ...
            <div class="row">
                <div class="col-sm-3">
                    <a href=""><img src="pictures/agbada27.jpg" id="img6" class="img img-fluid ankara" alt=""></a>
                    <section class="text-center" style="height:30px;width:100px;background-color:brown;color:ghostwhite;font-family: 'Times New Roman', Times, serif;font-size:20px;margin-top:-50px;margin-left:30px;">
                        Shop Now
                    </section>
                </div>
                <div class="col-sm-3">
                    <img src="pictures/agbada29.jpg" id="img7" class="img img-fluid ankara" alt="">
                    <section class="text-center" style="height:30px;width:100px;background-color:brown;color:ghostwhite;font-family: 'Times New Roman', Times, serif;font-size:20px;margin-top:-50px;margin-left:30px;">
                        Shop Now
                    </section>
                </div>
                <div class="col-sm-3">
                    <img src="pictures/agbada45.png"  id="img8" class="img img-fluid ankara" alt="">
                    <section class="text-center" style="height:30px;width:100px;background-color:brown;color:ghostwhite;font-family: 'Times New Roman', Times, serif;font-size:20px;margin-top:-50px;margin-left:30px;">
                        Shop Now
                    </section>
                </div>
                <div class="col-sm-3">
                    <img src="pictures/agbada22.jpg"  id="img9" class="img img-fluid ankara" alt="">
                    <section class="text-center" style="height:30px;width:100px;background-color:brown;color:ghostwhite;font-family: 'Times New Roman', Times, serif;font-size:20px;margin-top:-50px;margin-left:30px;">
                        Shop Now
                    </section>
                </div>
