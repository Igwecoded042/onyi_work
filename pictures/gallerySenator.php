    ...
    <div class="pix1">
        <div class="container">
            <div class="row">
                <!-- bigger image -->
                <div class="col-md-6">
                    <img src="pictures/Native-styles-for-ladies-14.jpg" class="img img-fluid ankara" id="pix2" alt="">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <a href=""><img src="pictures/senator11.jpg" class="img img-fluid ankara " id="img2" alt=""></a>
                        </div>
                        <div class="col-sm-3">
                            <img src="pictures/senator13.jpg" id="img3" class="img img-fluid ankara " alt="">
                        </div>
                        <div class="col-sm-3">
                            <img src="pictures/senator15.jpg"  id="img4" class="img img-fluid ankara " alt="" >
                        </div>
                        <div class="col-sm-3">
                            <img src="pictures/Native-styles-for-ladies-14.jpg" class="img img-fluid ankara " id="img5" alt="" >
                        </div>
                    </div>
                </div> 
                ...
                <!-- header title -->
                <div class="col-md-6">
                    <h4 id="head_title2"><b>SENATOR ANKARA DESIGNS</b></h4>
