    ...
    <div class="pix1">
        <div class="container">
            <div class="row">
                <!-- bigger image -->
                <div class="col-md-6">
                    <img src="pictures/shortey.jpg" class="img img-fluid ankara"id="pix2" alt="">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <a href=""><img src="pictures/base2.jpg" class="img img-fluid ankara" id="img2" alt=""></a>
                        </div>
                        <div class="col-sm-3">
                            <img src="pictures/scren1.jpg" id="img3" class=" img img-fluid ankara" alt="">
                        </div>
                        <div class="col-sm-3">
                            <img src="pictures/h1.jpg"  id="img4" class=" img img-fluid ankara" alt="" >
                        </div>
                        <div class="col-sm-3">
                            <img src="pictures/shortey.jpg"  id="img5" class="img img-fluid ankara" alt="" >
                        </div>
                    </div>
                </div> 
                ...
                <!-- header title -->
                <div class="col-md-6">
                    <h4 id="head_title2"><b>SHORT ANKARA GOWN DESIGNS</b></h4>
