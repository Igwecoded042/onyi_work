...
<div class="container-fluid"> 
    <div class="pix1">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <img src="pictures/senator.jpg" class="img img-fluid ankara" id="pix2" alt="">
                ...
                <div class="col-lg-6">
                    <h4 id="head_title2"><b>STYLISH AGBADA COLLECTIONS</b></h4>
            ...
            <!-- smaller images -->
            <div class="row">
                <div class="col-sm-3 mb-2" style="height:250px; overflow: hidden;">
                    <img src="pictures/senator3.jpg" id="img2" class="img img-fluid ankara" alt="">
                    <section class="text-center tags">
                        Shop Now
                    </section>
                </div>
                <div class="col-sm-3 mb-2" style="height:250px; overflow: hidden;">
                    <img src="pictures/sen1.jpg" id="img3" class="img img-fluid ankara" alt="">
                    <section class="text-center tags" style="height:30px;width:100px;background-color:brown;color:ghostwhite;font-family: 'Times New Roman', Times, serif;font-size:20px;margin-top:-115px;margin-left:30px;">
                        Shop Now
                    </section>
                </div>
                <div class="col-sm-3">
                    <img src="pictures/sen11.jpg" id="img4" class="img img-fluid ankara" alt="">
                ...
                <div class="col-sm-3">
                    <img src="pictures/sen.jpg"  id="img5" class="img img-fluid ankara" alt="">
                    <section class="text-center" style="height:30px;width:100px;background-color:brown;color:ghostwhite;font-family: 'Times New Roman', Times, serif;font-size:20px;margin-top:-50px;margin-left:30px;">
                        Shop Now
                    </section>
                </div>
            ...
            <!-- ************second row********** -->
            <div class="row">
                <div class="col-sm-3" style="height:250px; overflow: hidden;">
                    <img src="pictures/senator.jpg" id="img6" class="img img-fluid ankara" alt="">
                    <section class="text-center" style="height:30px;width:100px;background-color:brown;color:ghostwhite;font-family: 'Times New Roman', Times, serif;font-size:20px;margin-top:-50px;margin-left:30px;">
                        Shop Now
                    </section>
                </div>
                <div class="col-sm-3">
                    <img src="pictures/sen7.jpg" id="img7" class="img img-fluid ankara" alt="">
                    <section class="text-center" style="height:30px;width:100px;background-color:brown;color:ghostwhite;font-family: 'Times New Roman', Times, serif;font-size:20px;margin-top:-50px;margin-left:30px;">
                        Shop Now
                    </section>
                </div>
                <div class="col-sm-3">
                    <img src="pictures/sen9.jpg" id="img8" class="img img-fluid ankara" alt="">
                    <section class="text-center" style="height:30px;width:100px;background-color:brown;color:ghostwhite;font-family: 'Times New Roman', Times, serif;font-size:20px;margin-top:-50px;margin-left:30px;">
                        Shop Now
                    </section>
                </div>
                <div class="col-sm-3">
                    <img src="pictures/sen71.png" id="img9" class="img img-fluid ankara" alt="">
                    <section class="text-center" style="height:30px;width:100px;background-color:brown;color:ghostwhite;font-family: 'Times New Roman', Times, serif;font-size:20px;margin-top:-50px;margin-left:30px;">
                        Shop Now
                    </section>
                </div>
